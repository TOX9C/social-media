...
const ProfileCard = ({ isAccount, setEditShowing, setUserId }) => {
  ...
  return (
    <div className="shrink-0 overflow-y-auto scrollbar-hide h-screen w-full md:w-[50%] border-r-0 md:border-r-2 border-l-0 md:border-l-2 border-[#544c46] text-[#d6d2c0] select-none">
